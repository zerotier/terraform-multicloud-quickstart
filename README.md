...
- Installed equinix/metal v3.1.0 (signed by a HashiCorp partner, key
ID 1A65631C7288685E)
...
- Installed aliyun/alicloud v1.132.0 (signed by a HashiCorp partner,
key ID 47422B4AA9FA381B)
...
- Installed zerotier/zerotier v1.0.2 (signed by a HashiCorp partner,
key ID FE5A2DBE1B75988C)
- Installing ibm-cloud/ibm v1.30.0...
- Installed ibm-cloud/ibm v1.30.0 (self-signed, key ID
  AAD3B791C49CC253)
  - Installing digitalocean/digitalocean v2.11.1...
  - Installed digitalocean/digitalocean v2.11.1 (signed by a HashiCorp
  partner, key ID F82037E524B9C0E8)
  ...
  - Installed vultr/vultr v2.4.1 (signed by a HashiCorp partner, key
  ID 853B1ED644084048)
  ...
  forget, other
  commands will detect it and remind you to do so if necessary.~Upgrading modules...
- ali in modules/ali
- aws in modules/aws
- azu in modules/azu
- do in modules/do
